...
public class ExcelUpload {
    ...
    private WebElement findDownloadButtonInCurrentContext1() {
...
//            BaseTest.getDriver().switchTo().defaultContent();
//            BaseTest.getDriver().switchTo().frame("MultiPageiframeDialog2");
            BaseTest.getDriver().switchTo().frame("iframeFileDialog");
            System.out.println("Download");

            try {
                Utilities.Click(Testing);
            } catch (NumberFormatException e) {
                Testing.click();
            } catch (RuntimeException e) {
                 Utilities.JavaScriptClick(BaseTest.getDriver(),Testing);
            } catch (Exception e) {
                Utilities.ActionClick(BaseTest.getDriver(),Testing);
            }
    ...
    private void waitForDialogAppearance() {
        try {
            new WebDriverWait(BaseTest.getDriver(), Duration.ofSeconds(20))
