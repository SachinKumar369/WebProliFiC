...
public class HoldPage {
    ...
    public HoldPage(WebDriver driver){
    ...
    @FindBy(xpath = "//*[contains(@id, 'txtremarks')]")
...
//            Utilities.selectByContainsText(BaseTest.getDriver(), SelectApprove, "Approve");
            ...
            BaseTest.getDriver().switchTo().defaultContent();
            BaseTest.getDriver().switchTo().frame("MultiPageiframeBrw");
            Utilities.selectBy(BaseTest.getDriver(), "visibletext", SelectReject, "On Hold");
            Utilities.SendKeys(BaseTest.getDriver(),RejectReason,"Testing");
