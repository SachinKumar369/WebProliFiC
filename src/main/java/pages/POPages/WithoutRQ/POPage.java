...
public class POPage {
    ...
    // method to create PO without Requisition  RP AND CP PO
    public void POCreation() {
        ...
        try {
            ...
            BaseTest.getDriver().switchTo().frame("iframeGridDialog");
                ...
                String valueToSend = ""; // Variable to hold the value to send

                // Assign value based on the value of j
                if (j == 1) {
                    valueToSend = "CP";
                } else if (j == 2) {
                    valueToSend = "RP";
               ...
               // Utilities.SendKeys(BaseTest.getDriver(), EnterPOType, valueToSend);

                Utilities.SendKeys(BaseTest.getDriver(), POType, valueToSend);
