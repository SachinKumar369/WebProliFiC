...
public class AddProductFromDifferentPage {
    /**
     * Constructor
     */
    public AddProductFromDifferentPage(WebDriver driver) {
    ...
    public void AddProduct(String UserName) {
        try {
            ...
            int itemsFromPage1 = 3; // Define the number of items to pick from Page 1
                ...
                if (i >= itemsFromPage1 ) {
                    try {
                        ...
                        if (page2Button.isDisplayed() && page2Button.isEnabled()) {
                            Utilities.selectBy(BaseTest.getDriver(), "index", page2Button, "1"); // Switch to Page 2
