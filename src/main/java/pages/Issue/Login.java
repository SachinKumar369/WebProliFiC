...
public class Login extends BaseTest {
    ...
    @FindAll({@FindBy(how = How.XPATH, using = "//input[@id='txtChainID']"), @FindBy(how = How.ID, using = "txtChainID")})
    private static List<WebElement> ChainID;

    @FindAll({@FindBy(how = How.XPATH, using = "//input[@id='txtUnitID']"), @FindBy(how = How.ID, using = "txtUnitID")})
    private static List<WebElement> PropertyId;

    @FindAll({@FindBy(how = How.XPATH, using = "//input[@id='txtLogIN']"), @FindBy(how = How.ID, using = "txtLogIN")})
    private static List<WebElement> UserID;

    @FindAll({@FindBy(how = How.XPATH, using = "//input[@id='lblEnterPassword']"), @FindBy(how = How.ID, using = "lblEnterPassword")})
    private List<WebElement> Password;

    @FindAll({@FindBy(how = How.XPATH, using = "//span[@id='lblLogin_span']"), @FindBy(how = How.ID, using = "lblLogin_span")})
