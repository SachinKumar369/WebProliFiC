...
public class RQCreate {
    ...
    @FindBy(id = "cphBody_txtToDeptStore")
    ...
    public void AddProduct() {
        try {
            ...
            Utilities.SendKeys(FromDept,"1549");
            Utilities.SendKeys(ToDept,"89");
            ...
            String[] values = {"GSGN0004", "GSGN0007", "GSGS0022", "GSGS0031", "GSGS0041"};
            ...
            for(int i= 0; i < 5; i++){
                ...
                Utilities.SendKeys(BaseTest.getDriver(), getItemSearchElement(i), values[i]);
...
//
            ...
            ExcelHandler.loadExcelFile(Updload_Path1, 3);
    ...
    public void RQExpiryItems() {
        try {
            ...
            Utilities.SendKeys(FromDept,"1131");
            Utilities.SendKeys(ToDept,"80");
            ...
            String[] values = {"FDBC0071", "FDBC0065", "FDBC0086", "FDBC0243", "FDDF0003"};
...
//
    ...
    public void AddProductWithoutApprov() {
        try {
            //Getting All resoureces from Testdata excel sheet
            String Updload_Path = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "TestData" + File.separator + "TestData.xlsx";
