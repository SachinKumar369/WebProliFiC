...
public class KSTRequisition_Page {
    /**
     * Constructor
     */
    public KSTRequisition_Page(WebDriver driver) {
...
//            int randomIndex2 = random1.nextInt(DepartmentList.size());
            String ToDepartment1="";
            //String ToDepartment1 = DepartmentList.get(randomIndex2).getText();
...
//            String ToDepartment = DepartmentList.get(randomIndex2).getText();
