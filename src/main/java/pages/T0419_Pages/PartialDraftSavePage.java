...
public class PartialDraftSavePage {
    /**
     * Constructor
     */
    public PartialDraftSavePage(WebDriver driver) {
    ...
    @FindBy(id = "cphBody_chkpartialsave")
    private WebElement PartialDraft;
    ...
    public void AddProduct(String UserName) {
        try {
            ...
            //Select Partial Draft Save
            BaseTest.getDriver().switchTo().defaultContent();
            BaseTest.getDriver().switchTo().frame("MultiPageiframeDlg");
            Utilities.Click(BaseTest.getDriver(),PartialDraft);
            ...
            //Add Pack Item
            // Utilities.SendKeys(BaseTest.getDriver(), getItemSearchElement(0), "TBCG0037%");
