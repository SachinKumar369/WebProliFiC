...
public class ReqTemp_Page {
    /**
     * Constructor
     */
    public ReqTemp_Page(WebDriver driver) {
    ...
    @FindBy(xpath = "//input[@id=\"cphDialogHeader_btnSaveNew\"]")
    ...
    public void AddProduct(String UserName) {
        try {
            ...
            DynamicWait.smallWait();
            	...
            	Utilities.WaitTillElementDisplayed(BaseTest.getDriver(), NewBtn);
                Utilities.Click(BaseTest.getDriver(), NewBtn);
                DynamicWait.smallWait();
            }
            ...
            String RequestionType = Description.get(k);
