...
public class KQTempReq_Page {
    /**
     * Constructor
     */
    public KQTempReq_Page(WebDriver driver) {
    ...
    @FindBy(xpath = "//input[@id=\"cphDialogHeader_btnSave\"]")
    ...
    public void AddProductUsingTemplate(String UserName) {
        try {
            ...
            Utilities.WaitTillElementDisplayed(BaseTest.getDriver(), Filter);
            //To Select Requisition Type
            String RequestionType = Description.get(4);
            Utilities.SendKeys(BaseTest.getDriver(), Filter, RequestionType);
            DynamicWait.smallWait();
            Utilities.Click(BaseTest.getDriver(), FirstColumn);
            ...
            //Upload File
            String Uploaded_File = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "TestData" + File.separator + "INV19_NJ_T0419.xml";
            BaseTest.getDriver().switchTo().defaultContent();
            ...
            ChooseFile.sendKeys(Uploaded_File);
