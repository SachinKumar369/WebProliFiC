...
public class ReqHoldPage {
    /**
     * Constructor
     */
    public ReqHoldPage(WebDriver driver) {
...
//    private WebElement SelectApprove;
    ...
    @FindBy(xpath = "//option[@value=\"AP\"][1]")
    ...
    public void Approve() {
        try {
           ...
           // actions.doubleClick(BaseTest.getDriver().findElement(By.id("td_0_1")));
            ...
            Utilities.Click(BaseTest.getDriver(), OnHold);
...
//        	Utilities.Click(BaseTest.getDriver(), Approve);
