...
public class EditReq_Excel {
    /**
     * Constructor
     */
    public EditReq_Excel(WebDriver driver) {
    ...
    public void EditProduct() {
        try {
            ...
            //Enter requisition number from the Excel File
           // Utilities.SendKeys(BaseTest.getDriver(), NumberInputField, );
