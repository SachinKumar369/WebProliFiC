...
public class T0419 extends BaseTest {
    private final ThreadLocal<LaunchSite> launchSite = new ThreadLocal<>();
    private ThreadLocal<Faker> faker = new ThreadLocal<>();
    private final ThreadLocal<PortalLoginPage> loginPage = new ThreadLocal<>();
    private final ThreadLocal<AddProduct> addProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        faker.set(new Faker());
        addProduct.set(new AddProduct(getDriver()));
    }
