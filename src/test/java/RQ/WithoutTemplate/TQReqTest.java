...
import pages.T0419_Pages.TQReqPage;

import java.lang.reflect.Method;

public class TQReqTest extends BaseTest {
    ...
    private final ThreadLocal<TQReqPage> addProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        addProduct.set(new TQReqPage(getDriver()));
    }
