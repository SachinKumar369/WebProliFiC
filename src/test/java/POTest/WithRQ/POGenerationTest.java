...
import pages.POPages.WithRQ.POGeneration;
 ...
 * Date: 23-01-2025
 */
public class POGenerationTest extends BaseTest {
    ...
    private final ThreadLocal<POGeneration> POGenerationThread = new ThreadLocal<>();
...
//    private final ThreadLocal<RQApprove> RQApproveThread = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        POGenerationThread.set(new POGeneration(getDriver()));
...
//        RQApproveThread.set(new RQApprove(getDriver()));
    ...
    public void Login(Method m) {
        ...
        try {
            ...
            POGenerationThread.get().CreatePO();
