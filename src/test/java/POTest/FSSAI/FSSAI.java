...
public class FSSAI extends BaseTest {
    ...
    public void Login(Method m) {
        ...
        try {
            LoginThread.get().loginAndLaunchTestL2(m);
        } catch (Exception e) {
    ...
    public void SwitchProperty(Method m) {
        ...
        try {
            InventoryControlThread.get().Switch0529();
            POThread.get().AdvanceControl();
