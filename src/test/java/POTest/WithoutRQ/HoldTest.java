...
import pages.POPages.WithoutRQ.HoldPage;
...
public class HoldTest extends BaseTest {
    ...
    private final ThreadLocal<HoldPage>  HoldPageThread = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        HoldPageThread.set(new HoldPage(getDriver()));
    }
