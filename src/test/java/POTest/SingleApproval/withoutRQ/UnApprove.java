package POTest.SingleApproval.withoutRQ;
 ...
 * Date: 23-01-2025
 */
public class UnApprove extends BaseTest {
    ...
    private final ThreadLocal<RPPOPage> RPPOPageThread = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        RPPOPageThread.set(new RPPOPage(getDriver()));
