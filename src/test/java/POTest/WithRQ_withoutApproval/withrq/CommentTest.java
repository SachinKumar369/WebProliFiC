...
public class CommentTest extends BaseTest {
    ...
    @Test(priority = 4)
    public void CommentInstructions(Method m) {
        ExtentTestManager.startTest(this.getClass().getSimpleName() + " :: " + m.getName(), " PO Creation");
        ...
        try {
            ...
            ExtentTestManager.createAssertTestStepWithScreenshot("CommentInstructions", Status.PASS, "CommentInstructions Pass", true);

        } catch (Exception e) {
            ExtentTestManager.createAssertTestStepWithScreenshot("CommentInstructions", Status.FAIL, "Exception found in CommentInstructions", true, e);
        }
    }
}
