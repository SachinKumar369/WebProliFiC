...
public class PQApproval_Test extends BaseTest {
    ...
    private final ThreadLocal<IQApprove> addProduct = new ThreadLocal<>();
   // private final ThreadLocal<PQApproval_Page> approve = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        addProduct.set(new IQApprove(getDriver()));
      //  approve.set(new PQApproval_Page(getDriver()));
    }
