 ...
 * Date: 26-01-2025
 */
public class VRTest extends BaseTest {
    ...
    private final ThreadLocal<POPage> ValidationThread = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        ValidationThread.set(new POPage(getDriver()));
    }
    ...
    public void SRVTest(Method m) {
        ...
        try {
            ...
            ValidationThread.get().CreateSRV();

            ValidationThread.get().EnterRecivingItemz();
