...
public class CPQEdit_Test extends BaseTest {
    ...
    private final ThreadLocal<EditCPQ_Page> editProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
       ...
       // addProduct.set(new Requisition_Page(getDriver()));
        editProduct.set(new EditCPQ_Page(getDriver()));
    }
