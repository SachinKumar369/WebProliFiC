...
public class CQ_Test extends BaseTest {
    ...
    private final ThreadLocal<CQ_Page> addProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        addProduct.set(new CQ_Page(getDriver()));
    }
