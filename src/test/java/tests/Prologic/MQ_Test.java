...
import pages.T0419_Pages.MQReq_Page;
import pages.T0419_Pages.PQReq_Page;
...
public class MQ_Test extends BaseTest {
    ...
    private final ThreadLocal<MQReq_Page> addProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        addProduct.set(new MQReq_Page(getDriver()));
    }
