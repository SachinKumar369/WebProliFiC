...
import pages.T0419_Pages.MasterReq_Page;
...
public class MasterReq_Test extends BaseTest {
    ...
    private final ThreadLocal<MasterReq_Page> addProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        addProduct.set(new MasterReq_Page(getDriver()));
    }
