...
public class KSTRequisition_Test extends BaseTest {
    ...
    private final ThreadLocal<KSTRequisition_Page> addProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        addProduct.set(new KSTRequisition_Page(getDriver()));
    }
