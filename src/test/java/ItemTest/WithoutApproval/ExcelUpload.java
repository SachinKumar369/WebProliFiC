...
public class ExcelUpload extends BaseTest {
    ...
    public void  ItemCreate(Method m){
        ...
        try {
            ...
            ItemThread.get().ExcelUpload1();
            ExtentTestManager.createAssertTestStepWithScreenshot("Item Created", Status.PASS, "Item Creation Passed", true);

        } catch (Exception e) {
            ExtentTestManager.createAssertTestStepWithScreenshot("Item Created", Status.FAIL, "Exception found in Item Creation", true, e);
        }
    }
