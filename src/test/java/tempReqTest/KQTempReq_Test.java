...
public class KQTempReq_Test extends BaseTest {
    ...
    private final ThreadLocal<KQTempReq_Page> templatereq = new ThreadLocal<>();
   ...
   // private final ThreadLocal<PQEdit_Page> editProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        templatereq.set(new KQTempReq_Page(getDriver()));
