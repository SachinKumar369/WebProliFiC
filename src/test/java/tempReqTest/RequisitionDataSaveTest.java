...
import pages.T0419_Pages.RequisitionDataSave;
...
public class RequisitionDataSaveTest extends BaseTest {
    ...
    private final ThreadLocal<RequisitionDataSave> addProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        addProduct.set(new RequisitionDataSave(getDriver()));
    }
     ...
     */
    @Test
    public void ExcelSaveData(Method m) {
