...
import reqTemplatePage.ReqExcelDownloadUploadPage;
...
public class ReqExcelDownloadUpload extends BaseTest {
    ...
    private final ThreadLocal<ReqExcelDownloadUploadPage> templatereq = new ThreadLocal<>();
   ...
   // private final ThreadLocal<PQEdit_Page> editProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        templatereq.set(new ReqExcelDownloadUploadPage(getDriver()));
