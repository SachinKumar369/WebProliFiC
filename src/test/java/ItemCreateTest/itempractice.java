...
public class itempractice extends BaseTest {
    ...
    private final ThreadLocal<ItemPage> item = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        item.set(new ItemPage(getDriver()));
    }
