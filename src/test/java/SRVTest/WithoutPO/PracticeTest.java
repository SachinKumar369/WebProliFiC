...
public class PracticeTest extends BaseTest {
    ...
    private final ThreadLocal<PracticePage> PracticeThread = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        PracticeThread.set(new PracticePage(getDriver()));
