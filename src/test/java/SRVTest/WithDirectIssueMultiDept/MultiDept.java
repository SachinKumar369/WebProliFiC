package SRVTest.WithDirectIssueMultiDept;
 ...
 * Date: 26-01-2025
 */
public class MultiDept extends BaseTest {
    ...
    public void SwitchProperty(Method m) {
        ...
        try {
            ...
            InventoryControlThread.get().Switch0470();
    ...
    public void SRVTest(Method m) {
        ...
        try {
            ...
            SRVThread.get().EnterItemsDI();

            /// ////////
            // SRVThread.get().DirectIssue();
