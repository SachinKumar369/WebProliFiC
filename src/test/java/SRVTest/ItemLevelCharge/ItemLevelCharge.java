package SRVTest.ItemLevelCharge;
 ...
 * Date: 23-01-2025
 */
public class ItemLevelCharge extends BaseTest {
    ...
    public void EnterItems() {
        ...
        try {
            ...
            POThread.get().ItemCharges();
            //POThread.get().EditPO();
            // POThread.get().AddRow();
            //CommonActionThread.get().SaveDetailsinExcel();
            ExtentTestManager.createAssertTestStepWithScreenshot("EnterItems", Status.PASS, "Enter Items", true);

        } catch (Exception e) {
            ExtentTestManager.createAssertTestStepWithScreenshot("Enter Items", Status.FAIL, "Exception found in Entering elements", true, e);
        }
    }
