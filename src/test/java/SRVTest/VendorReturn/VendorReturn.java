 ...
 * Date: 23-01-2025
 */
public class VendorReturn extends BaseTest {
    ...
    @Test(priority = 5)
    public void VendorReturnTest() {
        ExtentTestManager.startTest(this.getClass().getSimpleName() + " :: ", "VendorReturnr");

        try {
            SRVThread.get().VendorReturn();
            ExtentTestManager.createAssertTestStepWithScreenshot("VendorReturn", Status.PASS, "VendorReturn Sucess", true);

        } catch (Exception e) {
            ExtentTestManager.createAssertTestStepWithScreenshot("VendorReturn", Status.FAIL, "Exception found in VendorReturn", true, e);
        }
    }
}
