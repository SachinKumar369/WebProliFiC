 ...
 * Date: 26-01-2025
 */
public class CloseGLPeriod extends BaseTest {
    ...
    public void MakePJV(Method m) {
        ...
        try {
            ...
            taxDeduction.get().closeGL();

            taxDeduction.get().selectTax_TDSOnContractor2Pct();
            taxDeduction.get().openHSNPickerAndFilterGST();
            //multipleGLaccount();
            taxDeduction.get().closeGLValidate();


//            taxDeduction.get().gstOnHold();
