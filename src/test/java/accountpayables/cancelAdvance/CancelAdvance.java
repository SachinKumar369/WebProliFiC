package accountpayables.cancelAdvance;
 ...
 * Date: 26-01-2025
 */
public class CancelAdvance extends BaseTest {
    ...
    public void Pay_Advance(Method m) {
        ...
        try {
            ...
            payAdvance.get().withCheque();
            payAdvance.get().saveandClose();
            payAdvance.get().cancleAdvance();
