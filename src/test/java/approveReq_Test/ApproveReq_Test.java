package approveReq_Test;
//
//public class ApproveReq_Test {
//
//}
...
//import approveReq.ApproveReq_Page;
...
public class ApproveReq_Test extends BaseTest {
    ...
    private final ThreadLocal<EditReq_Page> addProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        addProduct.set(new EditReq_Page(getDriver()));
    }
