...
public class EditReq_Test extends BaseTest {
    ...
    private final ThreadLocal<EditReq_Page> editProduct = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        editProduct.set(new EditReq_Page(getDriver()));
    }
    ...
    public void D2C(Method m) {
        ExtentTestManager.startTest(this.getClass().getSimpleName() + " :: " + m.getName(), "Joppa Portal Login");
        try {
