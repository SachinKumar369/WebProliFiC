...
import pages.RQ.RQTemplate;
import pages.RQ.RQ_Page;
import pages.T0419_Pages.SwitchProperty;
import reqTemplatePage.ReqTemp_Page;

import java.lang.reflect.Method;

public class RQTemp_Test extends BaseTest {
    ...
    private final ThreadLocal<ReqTemp_Page> templatereq = new ThreadLocal<>();
    private final ThreadLocal<RQTemplate> template = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        templatereq.set(new ReqTemp_Page(getDriver()));
        template.set(new RQTemplate(getDriver()));
    ...
    public void template(Method m) {
        ...
        try {
            ...
            template.get().AddProduct(Username);
