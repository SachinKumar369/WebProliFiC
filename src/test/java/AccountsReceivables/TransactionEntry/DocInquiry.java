...
import static pages.AccountsReceivables.ARPage.InquiryType.Doc_Inquiry;
import static pages.AccountsReceivables.ARPage.InquiryType.Invoice_Inquiry;

public class DocInquiry extends BaseTest {
    ...
    public void createARAccountTest(Method m) {
        ...
        try {
            ...
            arAccountPageThread.get().inquiry(Doc_Inquiry);
