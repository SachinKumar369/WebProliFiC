...
import pages.VendorCreation.GSTVendorPage;
import pages.VendorCreation.VendorPage;

import java.lang.reflect.Method;

public class VendorTaxCategory extends BaseTest {
    ...
    private final ThreadLocal<GSTVendorPage> GSTVendorThread = new ThreadLocal<>();
    ...
    public void setUpBrowser() {
        ...
        GSTVendorThread.set(new GSTVendorPage(getDriver()));
    }
    ...
    @Test(priority = 4)
    public void Attachment(Method m){
        ExtentTestManager.startTest(this.getClass().getSimpleName() + " :: " + m.getName(), " VendorCreate");
        try {
            GSTVendorThread.get().VendorTax();
